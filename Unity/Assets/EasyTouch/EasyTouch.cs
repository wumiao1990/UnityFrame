...
namespace BaseTouchSystem
{
    ...
    public class EasyTouch : MonoBehaviour
    {
        ...
        public GameObject ignoreUI = null; // if enabledUGUIMode == true, ignore this ugui element; only for guide
            ...
            if (tmpSystem != null)
            {
                ...
                if (uiRaycastResultCache.Count > 0)
                {
                    if (ignoreUI != null)
                    {
                        ...
                        {
                            if (uiRaycastResultCache[i].gameObject == ignoreUI)
                            {
                                uiRaycastResultCache.RemoveAt(i);
                                break;
                            }
                        }
                    }
